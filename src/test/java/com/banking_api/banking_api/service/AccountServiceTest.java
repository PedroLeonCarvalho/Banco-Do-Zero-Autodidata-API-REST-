...
class AccountServiceTest {
    ...
    @Mock
    private IEarningsRateStrategy iEarningsRateStrategy;
    @Mock
    ...
    void whenTestEarningsGenerate_thenReturnSucess() throws JSONException, BadResponseException {
        ...
        doReturn(iEarningsRateStrategy).when(accountTypeFactory).strategyMake(any(AccountType.class));
        doReturn(value).when(iEarningsRateStrategy).getSelicDataValue(any(AccountType.class));
...
//        when(accountTypeFactory.strategyMake(any(AccountType.class))).thenReturn(iEarningsRateStrategy);
//        when(iEarningsRateStrategy.getSelicDataValue(any(AccountType.class))).thenReturn(value);
        var expectedNewBalance = BigDecimal.valueOf(1105);
