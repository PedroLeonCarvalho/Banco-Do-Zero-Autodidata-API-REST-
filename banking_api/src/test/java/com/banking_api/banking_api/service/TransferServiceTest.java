...
//    }
    ...
    @Test
    void whenNotEnoughBalance_thenThrowException () throws UnauthorizedUserException, InsufficientBalanceException {
        var dto = TransferDTO.builder()
                .receiverId(1L)
                .senderId(2L)
        ...
        verify(accountService, times(0)).save(sender);
        verify(accountService, times(0)).save(receiver);
    ...
    @Test
    @DisplayName("When username logged its not the same wich owns the account")
    void whenUserUnauthorized_thenThrowException () throws UnauthorizedUserException, InsufficientBalanceException {
        var dto = TransferDTO.builder()
                .receiverId(1L)
                .senderId(2L)
                .value(new BigDecimal(100))
    ...
    @Test
    @DisplayName("When Account Receiver its not found")
    void whenReceiverisNotFound_thenThrowException () throws UnauthorizedUserException, InsufficientBalanceException {
        var dto = TransferDTO.builder()
                .receiverId(1L)
                .senderId(2L)
                .value(new BigDecimal(100))
        ...
        assertThrows( EntityNotFoundException.class, () -> {
            transferService.transfer(dto,nome);
        }, "Usuário de destino não localizado");
